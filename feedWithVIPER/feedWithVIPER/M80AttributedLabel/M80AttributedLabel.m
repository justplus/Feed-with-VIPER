...
- (void)commonInit
{
    ...
    _textFrame              = nil;
    _linkColor              = JXTBasicColor;
    _font                   = [UIFont systemFontOfSize:16];
    _textColor              = [UIColor blackColor];
    _highlightColor         = [UIColor colorWithRed:0xd9/255.0
                                              green:0xe6/255.0
                                               blue:0xf9/255.0
                                              alpha:1];
...
{
    // modified by zhaoliang 如果linkData为nil,则没有点击效果
    if (self.touchedLink && self.highlightColor && self.touchedLink.linkData)
    {
